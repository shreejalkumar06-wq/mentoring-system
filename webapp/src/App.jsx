...
const MainLayout = () => {
  ...
  const showGlobalSpline = !['/', '/signup'].includes(location.pathname);
    ...
    <div className="page-wrapper" style={{ display: 'flex', position: 'relative', zIndex: 1 }}>
      {showGlobalSpline && (
        <>
          ...
          <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: -1, pointerEvents: 'none', background: 'rgba(255,255,255,0.6)', backdropFilter: 'blur(3px)' }}></div>
        </>
      )}
